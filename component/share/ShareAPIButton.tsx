    ...
    return(
        <Container>
            <Flex>
                ...
                <SearchBtn src="/assets/image/share/instagram.png" onClick={shareWebShare}/>
                <SearchBtn src="/assets/image/share/twitter.png" onClick={shareTwitter}/>
                <SearchBtn src="/assets/image/share/facebook.png" onClick={shareFacebook}/>
            </Flex>
        </Container>
