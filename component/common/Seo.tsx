...
export default function Seo({ title }) {
    return (
        <Head>
            ...
            {/*// 트위터 카드 타입*/}
            <meta name="twitter:card" content="크리스마스다! 두근두근 어드벤트 캘린더"/>
            <meta name="twitter:title" content="두근두근 어드벤트 캘린더🎁"/>
            <meta name="twitter:description" content="다함께 크리스마스 즐기기✨"/>
            <meta name="twitter:image" content="https://pitapat-adventcalendar.site/assets/image/character/face_heart.png"/>
            <meta name="twitter:creator" content="@hayanco"/>
            <meta name="twitter:site" content="https://pitapat-adventcalendar.site/"/>
        </Head>
    );
}
